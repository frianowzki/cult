  ...
  return (
    <>
      <div style={{ maxWidth: 980, margin: '0 auto', padding: '24px clamp(16px, 4vw, 32px) 28px' }}>
        <div className="card" style={{ padding: 0, overflow: 'hidden', background: 'linear-gradient(180deg, rgba(20,18,17,0.96) 0%, rgba(13,12,11,0.98) 100%)' }}>
          <div style={{ height: 180, position: 'relative', background: 'linear-gradient(135deg, rgba(254,119,201,0.12) 0%, rgba(254,119,201,0.03) 35%, rgba(255,255,255,0.02) 100%)' }}>
